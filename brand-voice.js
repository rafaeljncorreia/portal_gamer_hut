/* ============================================================
   GAMER HUT — Guia de marca para geração de copys
   Fonte: Branding Book Gamer Hut v2 (tom de voz, fórmula, exemplos)
   Editável: ajuste o texto abaixo e toda copy passa a seguir a mudança.
   ============================================================ */
window.GH_BRAND = `
