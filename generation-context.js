/* ============================================================
   GAMER HUT — Contexto Geracional para IA
   Perfis de tom, vocabulário, descoberta, objeções reais e
   gatilhos de conversão por geração. Mercado: Brasil.
   Fonte: brandbook v2026.09 + inteligência de público (30/06/2026).
   NOTA: ajuste os blocos "OBJEÇÕES" e "O QUE FECHA A VENDA"
   conforme dados reais (Insights, DM, CTR) forem chegando.
   ============================================================ */
window.GH_GENERATIONS = {
  'gen-z': {
    id: 'gen-z',
    label: 'GEN Z',
    full: 'Geração Z (18-29)',
    emoji: '🎮',
    pctFeed: 45,
    desc: 'Drop como evento, estética visual forte, comunidade-first.',
    context: `
...
`,
  ...
  'millennial': {
    id: 'millennial',
    label: 'MILLENNIAL',
    full: 'Millennials (30-44)',
    emoji: '🕹️',
    pctFeed: 35,
    desc: 'Nostalgia ativa, curadoria, permanência da biblioteca.',
    context: `
...
`,
  ...
  'gen-x': {
    id: 'gen-x',
    label: 'GEN X',
    full: 'Geração X (45-60)',
    emoji: '👑',
    pctFeed: 20,
    desc: 'Legado, versão definitiva, completude de coleção.',
    context: `
