...
function extractJSON(text) {
  ...
  while (i < src.length) {
    ...
    try {
      ...
      // Aceita o shape legado (titulo/legenda/cenas na raiz) E o aninhado do V-CORE
      // (studio/descricao/roteiro na raiz). Sem isso, roteiro truncado é descartado inteiro.
      if (o && (o.titulo || o.legenda || o.cenas || o.studio || o.descricao || o.roteiro)) objs.push(o);
    } catch(e) {}
  }
...
var STUDIO_FIELDS = {
  ...
  block:    ['template','tagId','title','eyebrow','subtitle','fill','ink','pattern','titleSize','image'],
